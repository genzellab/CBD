...
z = 0;
%% IMPORTANT -  Blanking of samples both before and  the peak of the artefacts was only done for the following SDs -- 
% Rat 4 SD 3
% Rat 5 SD 4,2 & 6
% Rat 6 SD 1 & 2
...
%% Running this line for all SDs except for the ones mentioned above after commenting out the if-else statement just above this line.
% This line is for blanking out samples after the artefacts
% VV_pfc(art_period_index(count):art_period_index(count)+art_period_values(count))= mean(VV_pfc);
end
