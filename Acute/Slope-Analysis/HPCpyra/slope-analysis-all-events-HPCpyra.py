...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
all_events_veh = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_all_events_veh.csv', 
                                  sep=',', header=None)
...
DF.to_csv("slopes_HPCpyra_all_events_veh.csv")

# OFFSETS
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_all_events_veh.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
all_events_cbd = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_all_events_cbd.csv', 
                                  sep=',', header=None)
...
DF = pd.DataFrame(exps)
# save the dataframe as a csv file
DF.to_csv("slopes_HPCpyra_all_events_cbd.csv")


# OFFSETS
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_all_events_cbd.csv")
