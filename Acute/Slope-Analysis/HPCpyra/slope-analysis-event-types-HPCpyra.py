...
# Baseline
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
baseline_veh = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_baseline_veh.csv', 
                                  sep=',', header=None)
...
DF.to_csv("offsets_HPCpyra_baseline_veh.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
ripple_veh = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_ripple_veh.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_ripple_veh.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
sw_veh = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_sw_veh.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_sw_veh.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
swr_veh = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_swr_veh.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_swr_veh.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
complex_swr_veh = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_complex_swr_veh.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyracomplex_swr_veh.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
baseline_cbd = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_baseline_cbd.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_baseline_cbd.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
ripple_cbd = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_ripple_cbd.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_ripple_cbd.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
sw_cbd = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_sw_cbd.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_sw_cbd.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
swr_cbd = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_swr_cbd.csv', 
                                  sep=',', header=None)
...
offsets_ = fg.get_params('aperiodic_params', 'offset')
DF = pd.DataFrame(offsets_)
DF.to_csv("offsets_HPCpyra_swr_cbd.csv")
...
freq = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/freq.csv',
                   sep=',', header=None)
complex_swr_cbd = pd.read_csv('/home/genzellab/Desktop/Pelin/slope-analysis/HPCpyra/data/power_spec_complex_swr_cbd.csv', 
                                  sep=',', header=None)
