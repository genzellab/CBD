...
plot(mean(SW_Dur_Veh),mean(SW_Amp_Veh),'*','MarkerSize',20)
...
plot(nanmean(ripples_Dur_Veh),nanmean(ripples_Amp_Veh),'*','MarkerSize',20)
...
%%
plot(nanmean(SWRSW_Dur_Veh),nanmean(SWRSW_Amp_Veh),'*','MarkerSize',20)
...
plot(nanmean(SWRripples_Dur_Veh),nanmean(SWRripples_Amp_Veh),'*','MarkerSize',20)
...
plot(mean(cSWRSW_Dur_Veh),mean(cSWRSW_Amp_Veh),'*','MarkerSize',20)
...
plot(nanmean(cSWRripples_Dur_Veh),nanmean(cSWRripples_Amp_Veh),'*','MarkerSize',20)
