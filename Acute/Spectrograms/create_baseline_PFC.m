...
clc
clear
addpath('/Users/pelinozsezer/Documents/Science/Radboud/CBD-Project/binned-data/processed_data');
...
% remove NaN
NREM_PFCdeep_rat1_cbd=rmmissing(NREM_PFCdeep_rat1_cbd);
NREM_PFCdeep_rat2_cbd=rmmissing(NREM_PFCdeep_rat2_cbd);
NREM_PFCdeep_rat3_cbd=rmmissing(NREM_PFCdeep_rat3_cbd);
NREM_PFCdeep_rat4_cbd=rmmissing(NREM_PFCdeep_rat4_cbd);
NREM_PFCdeep_rat5_cbd=rmmissing(NREM_PFCdeep_rat5_cbd);
NREM_PFCdeep_rat6_cbd=rmmissing(NREM_PFCdeep_rat6_cbd);
NREM_PFCdeep_rat7_cbd=rmmissing(NREM_PFCdeep_rat7_cbd);
NREM_PFCdeep_rat8_cbd=rmmissing(NREM_PFCdeep_rat8_cbd);
NREM_PFCdeep_rat9_cbd=rmmissing(NREM_PFCdeep_rat9_cbd);
NREM_PFCdeep_rat10_cbd=rmmissing(NREM_PFCdeep_rat10_cbd);
...
for i=1:2000
    ...
    if rat == 1
        ...
        tw1 = NREM_PFCshal_rat1_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat1_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 2
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat2_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat2_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 3
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat3_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat3_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 4
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat4_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat4_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 5
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat5_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat5_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 6
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat6_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat6_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 7
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat7_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat7_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 8
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat8_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat8_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    elseif rat == 9
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw1 = NREM_PFCshal_rat9_veh(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat9_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw1];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw2];
    end
end
...
for i=1:2000
    ...
    if rat == 1
        ...
        tw1 = NREM_PFCshal_rat1_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat1_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 2
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat2_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat2_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 3
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat3_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat3_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 4
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat4_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat4_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 5
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat5_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat5_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 6
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat6_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat6_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 7
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat7_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat7_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 8
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat8_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat8_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 9
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat9_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat9_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    elseif rat == 10
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw1 = NREM_PFCshal_rat10_cbd(tw-fs*3:tw+fs*3);
        tw2 = NREM_PFCdeep_rat10_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw1];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw2];
    end
end
