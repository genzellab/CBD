...
%%
% Ripple, SW, & SWR: 1943 events
GC_PFCdeep_ripple_median1943_cbd=GC_PFCdeep_ripple_median2000_cbd(1:1943);
GC_PFCdeep_ripple_median1943_veh=GC_PFCdeep_ripple_median2000_veh(1:1943);
GC_PFCdeep_sw_median1943_cbd= GC_PFCdeep_sw_median2000_cbd(1:1943);
GC_PFCdeep_sw_median1943_veh= GC_PFCdeep_sw_median2000_veh(1:1943);
GC_PFCdeep_swr_median1943_veh= GC_PFCdeep_swr_median2000_veh(1:1943);
GC_PFCdeep_swr_median1943_cbd=GC_PFCdeep_swr_median2000_cbd(1:1943);
...
[freq_baseline_veh,freq_ripple_veh,freq_sw_veh,freq_swr_veh,freq_complex_swr_veh,...
    ...
    ...
    (GC_baseline_PFCdeep_veh,GC_PFCdeep_ripple_median1943_veh,GC_PFCdeep_sw_median1943_veh,...
    GC_PFCdeep_swr_median1943_veh,GC_PFCdeep_complex_swr_median1781_veh,...
    ...
    GC_baseline_PFCdeep_cbd,GC_PFCdeep_ripple_median1943_cbd,GC_PFCdeep_sw_median1943_cbd,...
    GC_PFCdeep_swr_median1943_cbd,GC_PFCdeep_complex_swr_median1274_cbd,freqrange,channel);

%
[contrast_zlim]=ft_getminmax_contrast_baseline_vs_eventtype...
    (freq_baseline_veh,freq_ripple_veh,freq_sw_veh,freq_swr_veh,freq_complex_swr_veh,...
    freq_baseline_cbd,freq_ripple_cbd,freq_sw_cbd,freq_swr_cbd,freq_complex_swr_cbd,channel);
...
cd /Users/pelinozsezer/Desktop/spectrograms/PFCdeep/Vehicle/'Complex SWR'/0-30
    % Baseline
    cfg              = [];
    cfg.zlim         = zlim;
    cfg.channel      = 'PFCdeep';
