...
% Depth 
NREM_grouped_wave_forms = (detection_ratID213_PFCshal_veh(NREM_idx,:)); % event x time(sample*6s)
...
%% Run until here and then adjust the code accordingly!
sw_grouped_oscil_table_PFCshal_ratID213              = sw_grouped_oscil_table;
GC_sw_waveforms_PFCshal_ratID213                     = GC_sw_waveforms;

ripple_grouped_oscil_table_PFCshal_ratID213          = ripple_grouped_oscil_table;
GC_ripple_waveforms_PFCshal_ratID213                 = GC_ripple_waveforms;

swr_grouped_oscil_table_PFCshal_ratID213             = swr_grouped_oscil_table;
GC_swr_waveforms_PFCshal_ratID213                    = GC_swr_waveforms;

complex_swr_grouped_oscil_table_PFCshal_ratID213     = complex_swr_grouped_oscil_table;
GC_complex_swr_waveforms_PFCshal_ratID213            = GC_complex_swr_waveforms;

% save
save('ratID213_PFCshal_veh.mat','sw_grouped_oscil_table_PFCshal_ratID213','GC_sw_waveforms_PFCshal_ratID213',...
    'ripple_grouped_oscil_table_PFCshal_ratID213','GC_ripple_waveforms_PFCshal_ratID213',...
    'swr_grouped_oscil_table_PFCshal_ratID213','GC_swr_waveforms_PFCshal_ratID213',...
    'complex_swr_grouped_oscil_table_PFCshal_ratID213','GC_complex_swr_waveforms_PFCshal_ratID213','-v7.3')
...
NREM_grouped_oscil_table = grouped_oscil_table(NREM_idx,:);
% Depth 
NREM_grouped_wave_forms = (detection_ratID213_PFCdeep_veh(NREM_idx,:)); % event x time(sample*6s)
