...
% 	sig{i,1} = tmp.grouped_oscil_table(:,2:5);    
% end
% [signals, sleep_states, signals_indexes, bins_num] = align_dataset("F:\OSF\swr_analysys\cleaned_pyra", "F:\OSF\CBD\PCA_state_files", 45);
% load('swr.mat')

cd 'F:\OSF\CBD\PFC'
load('p_hpc.mat')
load('b_hpc.mat')
time = (0:(size(b_signals,2)-1))/600;
