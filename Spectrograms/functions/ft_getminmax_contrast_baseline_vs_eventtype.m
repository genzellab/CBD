function [contrast_zlim] = ft_getminmax_contrast_baseline_vs_eventtype(freq_base1,freq1,freq2,freq3,freq4,...
    ...
    subs_freq = ft_math(cfg_m,  freq_base1, freq1); %first-second!!
    [zmin1, zmax1] = ft_getminmax(cfg, subs_freq);
    %
    cfg_m = [];
    cfg_m.operation = 'subtract';
    cfg_m.parameter = 'powspctrm';
    subs_freq = ft_math(cfg_m,  freq_base1, freq2); %first-second!!
    [zmin2, zmax2] = ft_getminmax(cfg, subs_freq);
    %
    cfg_m = [];
    cfg_m.operation = 'subtract';
    cfg_m.parameter = 'powspctrm';
    subs_freq = ft_math(cfg_m,  freq_base1, freq3); %first-second!!
    ...
    subs_freq = ft_math(cfg_m,  freq_base1, freq4); %first-second!!
    ...
    cfg_m.operation = 'subtract';
    cfg_m.parameter = 'powspctrm';
    subs_freq = ft_math(cfg_m,  freq_base2, freq5); %first-second!!
    [zmin5, zmax5] = ft_getminmax(cfg, subs_freq);
    %
    cfg_m = [];
    cfg_m.operation = 'subtract';
    cfg_m.parameter = 'powspctrm';
    subs_freq = ft_math(cfg_m,  freq_base2, freq6); %first-second!!
    [zmin6, zmax6] = ft_getminmax(cfg, subs_freq);
    %
    cfg_m = [];
    cfg_m.operation = 'subtract';
    cfg_m.parameter = 'powspctrm';
    subs_freq = ft_math(cfg_m,  freq_base2, freq7); %first-second!!
    ...
    subs_freq = ft_math(cfg_m,  freq_base2, freq8); %first-second!!
