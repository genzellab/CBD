...
for i=1:2000
    ...
    if rat == 1
        ...
        tw = NREM_PFCshal_rat1_veh(tw-fs*3:tw+fs*3);
    ...
    elseif rat == 2
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat2_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 3
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat3_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 4
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat4_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 5
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat5_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 6
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat6_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 7
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat7_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 8
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat8_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    elseif rat == 9
        ...
        tw = tw(1);
        tw_stored_veh=[tw_stored_veh; tw];
        tw = NREM_PFCshal_rat9_veh(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_veh=[waveforms_PFCshal_baseline_veh; tw];
        waveforms_PFCdeep_baseline_veh=[waveforms_PFCdeep_baseline_veh; tw];
    end
end
...
for i=1:2000
    ...
    if rat == 1
        ...
        tw = NREM_PFCshal_rat1_cbd(tw-fs*3:tw+fs*3);
    ...
    elseif rat == 2
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat2_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 3
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat3_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 4
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat4_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 5
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat5_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 6
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat6_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 7
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat7_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 8
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat8_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 9
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat9_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    elseif rat == 10
        ...
        tw = tw(1);
        tw_stored_cbd=[tw_stored_cbd; tw];
        tw = NREM_PFCshal_rat10_cbd(tw-fs*3:tw+fs*3);
        waveforms_PFCshal_baseline_cbd=[waveforms_PFCshal_baseline_cbd; tw];
        waveforms_PFCdeep_baseline_cbd=[waveforms_PFCdeep_baseline_cbd; tw];
    end
end
